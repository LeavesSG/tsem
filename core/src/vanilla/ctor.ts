export type ConstructorType<I = any, Args extends any[] = any[]> =
    abstract new (...args: Args) => I;
...
export type InstanceIntersection<T extends ConstructorType[], __O = object> =
    T extends [
...
export type ConcreteInstance<T extends abstract new (...args: any[]) => any> =
